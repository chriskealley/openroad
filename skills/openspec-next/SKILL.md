...
1. Read `openspec/roadmap.md`, validate it with `openspec-roadmap doctor`, and inspect active OpenSpec changes.
...
9. Preserve all unrelated roadmap content and run `openspec-roadmap doctor`.
